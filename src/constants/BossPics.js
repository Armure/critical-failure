...
export default {
  ...
  [`Harjatan`]: harjatan,
  [`Sisters of the Moon`]: sisters,
  [`Mistress Sassz'ine`]: mistress,
  [`The Desolate Host`]: host,
  ...
  [`Portal Keeper Hasabel`]: hasabel,
  [`Eonar the Life-Binder`]: eonar,
  [`Imonar the Soulhunter`]: imonar,
  [`Kin'garoth`]: kingaroth,
